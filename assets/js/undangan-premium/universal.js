...
// Open Modal
var openModal = function(modalContent, modal, clearModal = true) {
    // close opened modal
    if (clearModal) closeModal();

    // find modal
    var $modal = modal instanceof jQuery && modal.length ? modal : $('#modal');
...
// Close stacked modal
var closeStackedModal = function() {
    var $modal = $('#stackedModal');
...
// Post Data
// POST DATA DISABLED FOR LOCAL PREVIEW
...
var goto_calculator = function(e) {
    ...
    if (!redirect) redirect = 'https://www.dekeku.my.id';
...
if (typeof NProgress !== 'undefined') {
    ...
    // Ajax Start/Stop DISABLED FOR LOCAL PREVIEW
